...
const createUserValidator = [
  ...
  check("password", "Error con la contraseña")
    .exists()
    .withMessage("No se encontro la contraseña")
    .notEmpty()
    .withMessage("No se encontro un valor para la contraseña")
    .isString()
    .isLength({ min: 7 }),
  check("avatar", "Error en el avatar")  
    .isString()
    .withMessage("El avatar debe ser un URL"),
  (req, res, next) => {
...
const updateUserValidator = [
  ...
  check("avatar")
    ...
    .withMessage("El avatar debe ser un URL")
    .exists()
    .withMessage("No se encuentra el nombre para el avatar")
    .notEmpty()
    .withMessage("EL avatar no debe ser un string vacio"),
  (req, res, next) => {
    validateResult(req, res, next);
  },
];
